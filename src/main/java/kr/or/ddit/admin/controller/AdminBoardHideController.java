...
@WebServlet("/admin/board/hide.do")
public class AdminBoardHideController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            String isHidden = req.getParameter("isHidden");

            IadminService service = AdminServiceImpl.getinsetance();
            boolean result = service.updateBoardHidden(boardId, isHidden);
